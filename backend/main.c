...
/**
 * @file main.c
 * @brief Simple CGI program for visit counting using SQLite.
 */

/**
 * @brief Main function
 *
 * Opens a SQLite database, creates a table if it doesn't exist,
 * and either inserts a visit record or shows the current visit count and latest timestamp.
 *
...
int main(void) {
    ...
    // Check QUERY_STRING for action=increase
    ...
    if(increase){
        ...
        // Query visit count and latest timestamp
        sqlite3_stmt *stmt;
